...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DYFCryptoUtils/DYFCryptoUtils.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftPageView/SwiftPageView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyRSA/SwiftyRSA.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WisdomHUD/WisdomHUD.framework"
